...
```bash
git remote add encore encore://odoo-cafe-pos-system-vhsi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/odoo-cafe-pos-system-vhsi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/odoo-cafe-pos-system-vhsi/settings/integrations/github)
